...
let checkBlacklist = async (req, res) => {
  try {
    let infor = await doctorService.checkBlacklist(req.query.doctorId, req.query.email);
    return res.status(200).json(infor);
  } catch (e) {
    console.log(e);
    return res.status(200).json({
...
let getListPatientS7 = async (req, res) => {
  try {
    let infor = await doctorService.getListPatientS7(req.query.doctorId, req.query.patientId, req.query.statusId);
    return res.status(200).json(infor);
  } catch {
    console.log(e);
    return res.status(200).json({
